"""
Django settings for mealtime project.
...
SECRET_KEY = os.getenv('SECRET_KEY') or 'django-insecure-vercel-temporary-fallback-key-12345'
...
WSGI_APPLICATION = 'mealtime.wsgi.application'
